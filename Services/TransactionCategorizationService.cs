...
public class TransactionCategorizationService
{
    ...
    private static readonly Dictionary<string, List<string>> CategoryKeywords = new()
    {
        ...
        ["Bills"] = new() { "insurance" },
        ["Tax"] = new() { "tax", "revenue", "motor tax", "vat", "income tax", "property tax", "customs" },
        ["Subscription"] = new() { "subscription", "membership", "netflix", "spotify", "adobe", "amazon prime", "disney", "youtube", "office 365" },
